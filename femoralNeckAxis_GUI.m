...
GD.FNA_Algorithm.Objective = objectives{1};
...
uicontrol('Style', 'popup', 'String', objectives,...
    'Units','normalized','Position',[0.95-BSX*8/3 0.97 BSX*1/3 BSY],FontPropsB,FontPropsB,...
    'Callback', @DD_CB_Objective);
...
GD.FNA_Algorithm.PlaneVariationRange = 4;
uicontrol('Style','text','Units','normalized','BackgroundColor','w',...
