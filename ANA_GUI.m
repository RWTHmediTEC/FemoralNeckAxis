...
uicontrol('Units','normalized','Position',[0.13+BSX*1/2 0.97 BSX BSY],FontPropsA,...
    'String','Load','Callback',{@ANA_LoadSubject});
% Start button
uicontrol('Units','normalized','Position',[0.13+BSX*3/2 0.97 BSX BSY],FontPropsA,...
    'String','Start Calculation','Callback',@ANA_RoughFineIteration);


%% Controls on the Top of the GUI - RIGHT SIDE
% TODO: Add dropdown for Objective
GD.ANA_Algorithm.Objective='perimeter';
...
GD.ANA_Algorithm.PlaneVariationRange = 4;
